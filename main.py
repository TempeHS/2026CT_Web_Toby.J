...
def index():
    card_data = (
        ...
        ("Learn Python Syntax and Basic Variables", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ullamcorper lorem id venenatis condimentum. Nam ultricies nibh pharetra felis pretium tincidunt. Aliquam ullamcorper lorem id venenatis condimentum.", "Learn python the fun way today!", "static/images/card4beginner.svg"),
